...
from wan22.modules.attention import attention
from wan22.modules.model import (
    WanRMSNorm,
    rope_apply,
    WanLayerNorm,
    WanCrossAttention,
...
class CausalWanSelfAttention(nn.Module):
    ...
    def __init__(self,
        ...
        self.eps = eps
        self.max_attention_size = 18480 if local_attn_size == -1 else local_attn_size * 880
...
class CausalWanModel(ModelMixin, ConfigMixin):
    ...
    def _set_gradient_checkpointing(self, enable=True, gradient_checkpointing_func=None):
        # enable: bool
        # gradient_checkpointing_func: optional custom function
        self.gradient_checkpointing = enable

        if enable and gradient_checkpointing_func is not None:

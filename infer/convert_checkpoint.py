...
"""
This code is used to convert the model checkpoint trained by self-forcing to fit the videxfun inference pipeline.
"""
...
def main():
    ...
    parser.add_argument('--remove-prefix', type=str, nargs='?', const="", default="", help='Prefix to remove from keys (default: "model.")')

...
def get_teacache_coefficients(model_name):
    if "wan2.1-t2v-1.3b" in model_name.lower() or "wan2.1-fun-1.3b" in model_name.lower() \
        ...
        or "wan2.2-i2v-a14b" in model_name.lower() or "wan2.2-t2v-a14b" in model_name.lower() or "wan2.2-ti2v-5b" in model_name.lower()  or "hm_2.2_5b" in model_name.lower() or "i2v_2.2_5b" in model_name.lower() or "t2v_2.2_5b" in model_name.lower() \
